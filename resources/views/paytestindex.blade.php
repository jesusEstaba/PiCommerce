<html>
<head>
	<title>Mercury Web Services Sample</title>
</head>
<body>
	<table width="400" border="0" align="center" cellpadding="0" cellspacing="1">
				...
				<form name="form1" method="post" action="{{url('process-pay')}}">
					<table width="100%" border="0" cellspacing="1" cellpadding="3">
						...
						<tr>
							...
							<td width="30%"><input name="MerchantID" type="text" id="MerchantID" size="50" value="337234001"></td>
		...
		<tr>
			<td>
				<form style="display:none;" name="form2" method="post" action="ProcessTransaction.php">
					<table width="100%" border="0" cellspacing="1" cellpadding="3">
						<tr>
						...
						<tr>
							<td width="15%">AcctNo:</td>
							<td width="30%"><input name="AcctNo" type="text" id="AcctNo" size="50" value="6050110010032766771"></td>
							<td width="15%">Memo:</td>
							<td width="30%"><input name="Memo" type="text" id="Memo" size="50" value="Testing WebServices PHP"></td>
						</tr>
		...
		<tr>
			<td>
				<form style="display:none;" name="form3" method="post" action="CloseBatch.php">
					<table width="100%" border="0" cellspacing="1" cellpadding="3">
						<tr>
